...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exam.locale'
        db.add_column('editor_exam', 'locale',
                      self.gf('django.db.models.fields.CharField')(default='en-GB', max_length=200),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exam.locale'
        db.delete_column('editor_exam', 'locale')
