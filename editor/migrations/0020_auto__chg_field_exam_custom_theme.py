...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Exam.custom_theme'
        db.alter_column(u'editor_exam', 'custom_theme_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['editor.Theme']))

    def backwards(self, orm):

        # Changing field 'Exam.custom_theme'
        db.alter_column(u'editor_exam', 'custom_theme_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor.Theme'], null=True))
