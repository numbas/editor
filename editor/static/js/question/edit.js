...
$(document).ready(function() {
    ...
    Question.prototype = {
        ...
        instance: function() {
            ...
            q.generateVariables();
            return q.signals.on('ready').then(function(){ return Promise.resolve(q) });
        },
    ...
    function MarkingTest(part,scope) {
        ...
        ko.computed(function() {
            ...
            mt.part.q.instance().then(function(question) {
                try {
                    var part = question.getPart(mt.part.path());
                    if(!part) {
                        throw(new Error("Part not found"));
                    }
                    part.stagedAnswer = part.answerList = [mt.answer()];
