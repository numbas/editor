...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionHighlight'
        db.create_table(u'editor_questionhighlight', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor.Question'])),
            ('picked_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('note', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'editor', ['QuestionHighlight'])


    def backwards(self, orm):
        # Deleting model 'QuestionHighlight'
        db.delete_table(u'editor_questionhighlight')
    ...
    models = {
        ...
        u'editor.questionhighlight': {
            'Meta': {'object_name': 'QuestionHighlight'},
