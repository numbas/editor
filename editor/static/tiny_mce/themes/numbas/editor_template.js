...
(function(tinymce) {
	...
	tinymce.ThemeManager.requireLangPack('numbas');

	tinymce.create('tinymce.themes.NumbasTheme', {
		...
		init : function(ed, url) {
			...
			if (!s.theme_advanced_buttons1) {
				s = extend({
					theme_advanced_buttons1 : "bold,italic,underline,|,justifyleft,justifycenter,justifyright,justifyfull,|,formatselect|bullist,numlist,|,undo,redo,|,link,unlink,code",
				}, s);
			}
...
*/
	...
	tinymce.ThemeManager.add('numbas', tinymce.themes.NumbasTheme);
}(tinymce));
