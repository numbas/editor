...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
		orm.Question._meta.get_field_by_name('last_modified')[0].auto_now = False
		for question in orm.Question.objects.all():
			content = numbasobject.NumbasObject(question.content)
			for extension in orm.Extension.objects.filter(location__in=content.data.get('extensions',[])):
				question.extensions.add(extension)
			question.save()
