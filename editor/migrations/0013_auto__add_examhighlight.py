...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExamHighlight'
        db.create_table(u'editor_examhighlight', (
        ...
        db.send_create_signal(u'editor', ['ExamHighlight'])


    def backwards(self, orm):
        # Deleting model 'ExamHighlight'
        db.delete_table(u'editor_examhighlight')
