...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field extensions on 'Question'
        m2m_table_name = db.shorten_name(u'editor_question_extensions')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm[u'editor.question'], null=False)),
            ('extension', models.ForeignKey(orm[u'editor.extension'], null=False))
        ))
        db.create_unique(m2m_table_name, ['question_id', 'extension_id'])


    def backwards(self, orm):
        # Removing M2M table for field extensions on 'Question'
        db.delete_table(db.shorten_name(u'editor_question_extensions'))
    ...
    models = {
        ...
        u'editor.question': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1970, 1, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'extensions': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['editor.Extension']", 'symmetrical': 'False', 'blank': 'True'}),
            'filename': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1970, 1, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'metadata': ('editor.jsonfield.JSONField', [], {'blank': 'True'}),
