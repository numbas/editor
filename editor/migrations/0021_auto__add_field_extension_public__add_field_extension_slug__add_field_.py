...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Extension.public'
        db.add_column(u'editor_extension', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Extension.slug'
        db.add_column(u'editor_extension', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='an-extension', max_length=200),
                      keep_default=False)

        # Adding field 'Extension.author'
        db.add_column(u'editor_extension', 'author',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='own_extensions', null=True, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'Extension.last_modified'
        db.add_column(u'editor_extension', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Extension.zipfile'
        db.add_column(u'editor_extension', 'zipfile',
                      self.gf('django.db.models.fields.files.FileField')(max_length=255, null=True, blank=True),
                      keep_default=False)

        # Adding unique constraint on 'Extension', fields ['location']
        db.create_unique(u'editor_extension', ['location'])


    def backwards(self, orm):
        # Removing unique constraint on 'Extension', fields ['location']
        db.delete_unique(u'editor_extension', ['location'])

        # Deleting field 'Extension.public'
        db.delete_column(u'editor_extension', 'public')

        # Deleting field 'Extension.slug'
        db.delete_column(u'editor_extension', 'slug')

        # Deleting field 'Extension.author'
        db.delete_column(u'editor_extension', 'author_id')

        # Deleting field 'Extension.last_modified'
        db.delete_column(u'editor_extension', 'last_modified')

        # Deleting field 'Extension.zipfile'
        db.delete_column(u'editor_extension', 'zipfile')
    ...
    models = {
        ...
        u'editor.exam': {
            ...
            'custom_theme': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'used_in_exams'", 'null': 'True', 'on_delete': 'models.SET_NULL', 'to': u"orm['editor.Theme']"}),
            ...
            'theme': ('django.db.models.fields.CharField', [], {'default': "'default'", 'max_length': '200', 'blank': 'True'})
        },
        u'editor.examaccess': {
        ...
        u'editor.extension': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'own_extensions'", 'null': 'True', 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1970, 1, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'default': "''", 'unique': 'True', 'max_length': '200', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "'an-extension'", 'max_length': '200'}),
            'url': ('django.db.models.fields.CharField', [], {'max_length': '300', 'blank': 'True'}),
            'zipfile': ('django.db.models.fields.files.FileField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'})
        },
        u'editor.image': {
        ...
        u'editor.theme': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'own_themes'", 'to': u"orm['auth.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1970, 1, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'public': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '200'}),
            'zipfile': ('django.db.models.fields.files.FileField', [], {'max_length': '255'})
        }
    }
