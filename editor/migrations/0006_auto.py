...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field resources on 'Question'
        db.create_table(u'editor_question_resources', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm[u'editor.question'], null=False)),
            ('image', models.ForeignKey(orm[u'editor.image'], null=False))
        ))
        db.create_unique(u'editor_question_resources', ['question_id', 'image_id'])


    def backwards(self, orm):
        # Removing M2M table for field resources on 'Question'
        db.delete_table('editor_question_resources')
