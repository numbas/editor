    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(default=datetime.datetime(1970, 1, 1, 1, 0), auto_now_add=True)),
                ('last_modified', models.DateTimeField(default=datetime.datetime(1970, 1, 1, 1, 0), auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(default=datetime.datetime(1970, 1, 1, 1, 0), auto_now_add=True)),
                ('exam', models.ForeignKey(to='editor.Exam')),
