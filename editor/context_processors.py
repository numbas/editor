...
def get_mathjax_4_url(request):
    if request.user.is_anonymous or request.user.userprofile.mathjax_4_url=='':
        return settings.MATHJAX_4_URL
    else:
        return request.user.userprofile.mathjax_4_url
...
def global_settings(request):
    return {
        ...
        'MATHJAX_URL': get_mathjax_4_url(request),
