												...
												[
													...
													_List_fromArray(
														[
															...
															function () {
																var _v12 = $author$project$QuestionEditor$variable_type(variable);
																if (_v12.$ === 'Just') {
																	var type_ = _v12.a;
																	return _List_fromArray(
																		[
