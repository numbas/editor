...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.copy_of'
        db.add_column(u'editor_question', 'copy_of',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor.Question'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.copy_of'
        db.delete_column(u'editor_question', 'copy_of_id')
    ...
    models = {
        ...
        u'editor.question': {
            ...
            'content': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'copy_of': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['editor.Question']", 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1970, 1, 1, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'filename': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(1970, 1, 1, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
