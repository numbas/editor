...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Theme.last_modified'
        db.add_column(u'editor_theme', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(1970, 1, 1, 0, 0), auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Theme.last_modified'
        db.delete_column(u'editor_theme', 'last_modified')
    ...
    models = {
        ...
        u'editor.exam': {
            ...
            'custom_theme': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['editor.Theme']", 'null': 'True', 'blank': 'True'}),
