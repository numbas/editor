...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'EditorTag'
        db.create_table(u'editor_editortag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100)),
            ('official', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'editor', ['EditorTag'])

        # Adding model 'TaggedQuestion'
        db.create_table(u'editor_taggedquestion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('object_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('content_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'editor_taggedquestion_tagged_items', to=orm['contenttypes.ContentType'])),
            ('tag', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor.EditorTag'])),
        ))
        db.send_create_signal(u'editor', ['TaggedQuestion'])


    def backwards(self, orm):
        # Deleting model 'EditorTag'
        db.delete_table(u'editor_editortag')

        # Deleting model 'TaggedQuestion'
        db.delete_table(u'editor_taggedquestion')
    ...
    models = {
        ...
        u'editor.taggedquestion': {
            ...
            'tag': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['editor.EditorTag']"})
        }
    }
