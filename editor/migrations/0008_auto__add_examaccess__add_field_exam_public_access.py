...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExamAccess'
        db.create_table(u'editor_examaccess', (
        ...
        db.send_create_signal(u'editor', ['ExamAccess'])

        # Adding field 'Exam.public_access'
        db.add_column(u'editor_exam', 'public_access',
                      self.gf('django.db.models.fields.CharField')(default='view', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ExamAccess'
        db.delete_table(u'editor_examaccess')

        # Deleting field 'Exam.public_access'
        db.delete_column(u'editor_exam', 'public_access')
