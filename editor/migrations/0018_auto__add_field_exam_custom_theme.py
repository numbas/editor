...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exam.custom_theme'
        db.add_column(u'editor_exam', 'custom_theme',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor.Theme'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exam.custom_theme'
        db.delete_column(u'editor_exam', 'custom_theme_id')
    ...
    models = {
        ...
        u'editor.exam': {
            ...
            'custom_theme': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['editor.Theme']", 'null': 'True'}),
