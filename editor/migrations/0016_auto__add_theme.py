...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Theme'
        db.create_table(u'editor_theme', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=200)),
            ('author', self.gf('django.db.models.fields.related.ForeignKey')(related_name='own_themes', to=orm['auth.User'])),
            ('zipfile', self.gf('django.db.models.fields.files.FileField')(max_length=255)),
        ))
        db.send_create_signal(u'editor', ['Theme'])


    def backwards(self, orm):
        # Deleting model 'Theme'
        db.delete_table(u'editor_theme')
