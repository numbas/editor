...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'QuestionAccess'
        db.create_table(u'editor_questionaccess', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('question', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['editor.Question'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('access', self.gf('django.db.models.fields.CharField')(default='view', max_length=6)),
        ))
        db.send_create_signal(u'editor', ['QuestionAccess'])

        # Adding field 'Question.public_access'
        db.add_column(u'editor_question', 'public_access',
                      self.gf('django.db.models.fields.CharField')(default='view', max_length=6),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'QuestionAccess'
        db.delete_table(u'editor_questionaccess')

        # Deleting field 'Question.public_access'
        db.delete_column(u'editor_question', 'public_access')
